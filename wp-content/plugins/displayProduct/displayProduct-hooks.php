...
function dp_register_my_custom_submenu_page() {
        ...
        if ( current_user_can( 'manage_woocommerce' ) )
            add_submenu_page( 'edit.php?post_type=dp_template', __( 'DP Settings', DP_TEXTDOMAN ),  __( 'DP Settings', DP_TEXTDOMAN ), 'manage_options', 'display-product-page', 'display_product_callback' ); 
}
...
function display_product_callback() {
	...
	echo '<div class="dp-title-block"><div class="wrap"><div id="icon-tools"><img src="'.plugin_dir_url(__FILE__).'/assets/js/display-icon.png"></div>';
		echo '<h2>Display product Settings</h2>
                        <h5>
...
function dp_page_template_redirect()
{
    ...
    $dp_taxonomy=!empty($wp_query->query_vars['taxonomy'])?$wp_query->query_vars['taxonomy']:'';
    //PRODUCT CATEGORY
    $dp_redirect_to='';
