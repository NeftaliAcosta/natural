...
<div class="container">
	...
	<br/><br/>
		<div class="row">
			<div class=" col-xs-12 col-sm-6 col-md-6 col-lg-6" >
				<div class="brighten pic">
					<a href="materias-primas.html"><img src="http://54.68.89.0/natural/wp-content/uploads/2016/05/mat1.png" alt="Materias primas" class="img-responsive"></a>
				</div>
			</div>
			<br class="visible-xs"><br class="visible-xs">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<div class="brighten pic">
					<a href="servicios.html"><img src="http://54.68.89.0/natural/wp-content/uploads/2016/05/mat2.png" alt="Asesoría en aplicacines" class="img-responsive"></a>
					</div>
			</div>
		</div>
		<br>
		<div class="row">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" >
				<div class="brighten pic">
					<a href="producto-terminado.html"><img src="http://54.68.89.0/natural/wp-content/uploads/2016/05/mat3.png" alt="productos terminados" class="img-responsive"></a>
				</div>
			</div>
			<br class="visible-xs">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<div class="brighten pic"><a href="certificaciones.html"><img src="http://54.68.89.0/natural/wp-content/uploads/2016/05/mat4.png" alt="certificaciones" class="img-responsive"></a> </div>
			</div>
		</div>
	<br>
	</div></div>
...
<!-- fin sección blog -->
	...
	<div class="container-flouid contacto row">
			<div class="container">
			<br><br><br>
				<h1>Contáctanos</h1>
				...
				<div class="col-md-8">
				<!-- div del formulario--> 
				<form class="form-horizontal" role="form" method="post" id="myform" name="myform" action="mail.php">
					  <div class="form-group">
						 
							<div class="col-md-6">
							  <input type="name" class="form-control fondo" name="name" id="name"
									 placeholder="Nombre" required>
							</div>
							 <br class="visible-xs">
							<div class="col-md-6">
							  <input type="email" class="form-control fondo" name="email" id="email"
					  ...
					  <div class="form-group">
						  <div class="col-md-12">
						  <textarea class="form-control fondo" name="message" id="message"  rows="10" id="text"></textarea>
						  </div>
					  </div>
					  
					  
					  <!--Inicio  Detalles de contacto versión móvil-->
						<!--<button class="btn visible-xs" data-toggle="collapse" data-target="#info">Detalles de Contacto</button>
							<div id="info" class="collapse">
							<p align="justify">Río Azul No. 110, Col. Las Pintitas El salto Jalisco México, C.P. 45693
							</p>
							Telefonos:
							<ul>
							<li>(33) 3684 8983</li>
							...
							<p>Lada. 01 800 837 77 09</p>
							<p>servicioaclientes@naturalproducts.com.mx</p>
							<p>rguzman@naturalproducts.com.mx</p>
							</div>
							
							
							
						
					   <!-- Fin Detalles de contacto versión móvil-->
					

					  <div class="form-group">
							<div class="col-lg-offset-2 col-lg-10">
							  <button type="submit" id="#enviar"name="mysubmit"  class="btn btn-default fondo s">Enviar</button>
							</div>
					  </div>
				...
				<div class="col-md-4 visible-ms visible-md visible-lg">
				
				 
				
				
				<!-- div de los detalles de contacto -->
				<p align="justify">Río Azul No. 110, Col. Las Pintitas El salto Jalisco México, C.P. 45693
				</p>
				Telefonos:
				<ul>
				...
				<p>Lada. 01 800 837 77 09</p>
				<p>servicioaclientes<img src="<?php bloginfo( 'template_url' ); ?>/imgs/arroba.png" alt="arroba" />naturalproducts.com.mx</p>
				<p>rguzman<img src="<?php bloginfo( 'template_url' ); ?>/imgs/arroba.png" alr="arroba" />naturalproducts.com.mx</p>
				</div>
