...
* Title Product name
***********************/
<?php if(!empty($dp_title['column_width'])): ?>
.dp--wrapper-header-title,th.dp--tablehead-title{
    width: <?php echo $dp_title['column_width'];?>;
}
<?php endif;?>
...
#displayProduct-<?php echo $display_id;?> .product_table .product-name,
#displayProduct-<?php echo $display_id;?> .product_table .product-name a{
...
#displayProduct-<?php echo $display_id;?> .product_table .product-name:hover,
#displayProduct-<?php echo $display_id;?> .product_table .product-name a:hover{
...
* Title Content
***********************/
<?php if(!empty($dp_content['column_width'])): ?>
.dp--wrapper-header-content,th.dp--tablehead-content{
    width: <?php echo $dp_content['column_width'];?>;
}
<?php endif;?>
...
#displayProduct-<?php echo $display_id;?> .product_table .dp-grid-content,
#displayProduct-<?php echo $display_id;?> .product_table .dp-grid-content a{
...
#displayProduct-<?php echo $display_id;?> .product_table .dp-grid-content:hover,
#displayProduct-<?php echo $display_id;?> .product_table .dp-grid-content a:hover{
...
* Title Excerpt
***********************/
<?php if(!empty($dp_excerpt['column_width'])): ?>
.dp--wrapper-header-excerpt,th.dp--tablehead-excerpt{
    width: <?php echo $dp_excerpt['column_width'];?>;
}
<?php endif;?>
...
#displayProduct-<?php echo $display_id;?> .product_table .dp-grid-excerpt,
#displayProduct-<?php echo $display_id;?> .product_table .dp-grid-excerpt a{
...
#displayProduct-<?php echo $display_id;?> .product_table .dp-grid-excerpt:hover,
#displayProduct-<?php echo $display_id;?> .product_table .dp-grid-excerpt a:hover{
...
* Title Price
***********************/
<?php if(!empty($dp_price['column_width'])): ?>
.dp--wrapper-header-price,th.dp--tablehead-price{
    width: <?php echo $dp_price['column_width'];?>;
}
<?php endif;?>
.dp-grid-price{
    float: left;
...
* Title Product SKU
***********************/
<?php if(!empty($dp_sku['column_width'])): ?>
.dp--wrapper-header-sku,th.dp--tablehead-sku{
    width: <?php echo $dp_sku['column_width'];?>;
}
<?php endif;?>
...
#displayProduct-<?php echo $display_id;?> .product_table .dp-sku,
#displayProduct-<?php echo $display_id;?> .product_table .dp-sku a{
...
#displayProduct-<?php echo $display_id;?> .product_table .dp-sku:hover,
#displayProduct-<?php echo $display_id;?> .product_table .dp-sku a:hover{
...
* Meta Custom Field
***********************/
<?php if(!empty($dp_meta['column_width'])): ?>
.dp--wrapper-header-meta,th.dp--tablehead-meta{
    width: <?php echo $dp_meta['column_width'];?>;
}
<?php endif;?>
...
***********************/
<?php if(!empty($dp_category['column_width'])): ?>
.dp--wrapper-header-category,th.dp--tablehead-category{
    width: <?php echo $dp_category['column_width'];?>;
}
<?php endif;?>
...
#displayProduct-<?php echo $display_id;?> .product_table .dp-category,
#displayProduct-<?php echo $display_id;?> .product_table .dp-category a{
    color: <?php echo $dp_category['color'];?>;
    font-family: <?php echo $dp_category['font-family']!='disable'?$dp_category['font-family']: 'inherit';?>;
    font-size: <?php echo $dp_category['font-size'];?>px;
    font-weight: <?php echo $dp_category['weight'];?>;
    font-style: <?php echo $dp_category['style-italic'];?>;
    text-decoration: <?php echo $dp_category['style-underline'];?>;
    line-height: 25px;
}
#displayProduct-<?php echo $display_id;?> .product_table .dp-category:hover,
#displayProduct-<?php echo $display_id;?> .product_table .dp-category a:hover{
    color: <?php echo $dp_category['HoverColor'];?>;
    font-weight: <?php echo $dp_category['HoverWeight'];?>;
    font-style: <?php echo $dp_category['hover-style-italic'];?>;
    text-decoration: <?php echo $dp_category['hover-style-underline'];?>;
}
...
/* dp col*/
/*#displayProduct-<?php echo $display_id;?> .product_table .dp-col{
    background: '.$backgroundcolor.';
    color: '.$textcolor.';
}
#displayProduct-<?php echo $display_id;?> .product_table .dp-col:hover{
...
/* Link */
/*#displayProduct-<?php echo $display_id;?> .product_table a, 
#displayProduct-<?php echo $display_id;?> .product_table a:active, 
#displayProduct-<?php echo $display_id;?> .product_table a:visited,
#displayProduct-<?php echo $display_id;?> .product_meta a,
#displayProduct-<?php echo $display_id;?> .db_customtext
{
    color: '.$linkcolor.';
}*/
/*#displayProduct-<?php echo $display_id;?> .product_table a:hover,
...
* ADD TO CART BUTTON
***********************/
<?php if(!empty($dp_button['column_width'])): ?>
.dp--wrapper-header-button,th.dp--tablehead-button{
    width: <?php echo $dp_button['column_width'];?>;
}
<?php endif;?>
