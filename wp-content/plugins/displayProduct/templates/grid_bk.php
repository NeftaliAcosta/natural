            ...
            $result.='<div class="dp-stock"></div>';
                switch ($dp_button['type']) {
                    case 'buttonquantity':
                        ...
                        break;
                    case 'productDetail':
                        $result.='<div class="dp-grid-button">' . dp_add_to_cart_productdetail(get_permalink(),$dp_button['custom_text']) . '</div>';
                        break;
                    case 'customButton':
                        $result.='<div class="dp-grid-button">' . dp_add_to_cart_customButton($dp_button['custom_url'],$dp_button['custom_text']) . '</div>';
                        break;
                    case 'customText':
                        $result.='<div class="dp-grid-button">' . dp_add_to_cart_customText($dp_button['custom_url'],$dp_button['custom_text']) . '</div>';
                        break;
                    default:
