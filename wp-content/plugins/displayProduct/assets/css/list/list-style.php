...
#displayProduct-<?php echo $display_id;?> .product_list .product-name,
#displayProduct-<?php echo $display_id;?> .product_list .product-name a{
...
#displayProduct-<?php echo $display_id;?> .product_list .product-name:hover,
#displayProduct-<?php echo $display_id;?> .product_list .product-name a:hover{
...
#displayProduct-<?php echo $display_id;?> .product_list .dp-grid-content,
#displayProduct-<?php echo $display_id;?> .product_list .dp-grid-content a{
...
#displayProduct-<?php echo $display_id;?> .product_list .dp-grid-content:hover,
#displayProduct-<?php echo $display_id;?> .product_list .dp-grid-content a:hover{
...
#displayProduct-<?php echo $display_id;?> .product_list .dp-grid-excerpt,
#displayProduct-<?php echo $display_id;?> .product_list .dp-grid-excerpt a{
...
#displayProduct-<?php echo $display_id;?> .product_list .dp-grid-excerpt:hover,
#displayProduct-<?php echo $display_id;?> .product_list .dp-grid-excerpt a:hover{
...
#displayProduct-<?php echo $display_id;?> .product_list .dp-sku,
#displayProduct-<?php echo $display_id;?> .product_list .dp-sku a{
...
#displayProduct-<?php echo $display_id;?> .product_list .dp-sku:hover,
#displayProduct-<?php echo $display_id;?> .product_list .dp-sku a:hover{
...
#displayProduct-<?php echo $display_id;?> .product_list .dp-category,
#displayProduct-<?php echo $display_id;?> .product_list .dp-category a{
    color: <?php echo $dp_sku['color'];?>;
    font-family: <?php echo $dp_sku['font-family']!='disable'?$dp_sku['font-family']: 'inherit';?>;
    font-size: <?php echo $dp_sku['font-size'];?>px;
    font-weight: <?php echo $dp_sku['weight'];?>;
...
#displayProduct-<?php echo $display_id;?> .product_list .dp-category:hover,
#displayProduct-<?php echo $display_id;?> .product_list .dp-category a:hover{
    color: <?php echo $dp_sku['HoverColor'];?>;
    font-weight: <?php echo $dp_sku['HoverWeight'];?>;
    font-style: <?php echo $dp_sku['hover-style-italic'];?>;
    text-decoration: <?php echo $dp_sku['hover-style-underline'];?>;
...
/* dp col*/
/*#displayProduct-<?php echo $display_id;?> .product_list .dp-col{
    background: '.$backgroundcolor.';
    color: '.$textcolor.';
}
#displayProduct-<?php echo $display_id;?> .product_list .dp-col:hover{
...
/* Link */
/*#displayProduct-<?php echo $display_id;?> .product_list a, 
#displayProduct-<?php echo $display_id;?> .product_list a:active, 
#displayProduct-<?php echo $display_id;?> .product_list a:visited,
#displayProduct-<?php echo $display_id;?> .product_meta a,
#displayProduct-<?php echo $display_id;?> .db_customtext
{
    color: '.$linkcolor.';
}*/
/*#displayProduct-<?php echo $display_id;?> .product_list a:hover,
